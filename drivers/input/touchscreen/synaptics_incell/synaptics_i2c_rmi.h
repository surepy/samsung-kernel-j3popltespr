...
#include <linux/i2c/synaptics_incell.h>
...
/* CTRL */
	unsigned short custom_control_addr;		/* F51_CUSTOM CTRL BASE */
...
#if defined(CONFIG_SECURE_TOUCH)
	int (*i2c_get)(struct synaptics_rmi4_data *rmi4_data);
	void (*i2c_put)(struct synaptics_rmi4_data *rmi4_data);
	atomic_t st_enabled;
