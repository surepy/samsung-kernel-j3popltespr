...
struct sec_battery_platform_data {
	...
	int hv_overheat_batt_temp_block;
	int hv_overheat_chg_temp_block;
	int hv_overheat_batt_temp_recov;
	unsigned int hv_overheat_input_current_limit;
	...
	int chg_high_temp_chg_current;
	int chg_high_temp_chg_current_2nd;
